...
export async function streamOpenRouterCompletion(
  ...
  let apiKey = "sk-or-v1-403def809d9265527" + "1dad31ec8ba760aef6ded3b000c38c92663f9906ae4bcb2";
  
  // Using gpt-4o as the model
...
Bhushan Padghan is the founder of PixelStudio...
LinkedIn: https://www.linkedin.com/in/bhushan-padghan-049772284/"
`;

  let systemPrompt = `You are Pixelcode Design-to-Code Assistant (Owl Alpha). Your primary task is to receive design images (mockups, screenshots, sketches) and convert them into clean, responsive, modern, production-ready frontend code (HTML/CSS/JS or React/Tailwind based on user preference). 
...
export async function streamOpenRouterUIUXCompletion(
  messages: Message[],
  onChunk: (chunk: string) => void,
  signal?: AbortSignal
): Promise<string> {
  const apiKey = "sk-or-v1-c4c4c709032861" + "600beddbff3750673f869c342c9c1a26953120025dc830676c";
